...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-video.js/node_modules/video.js/es5/control-bar/text-track-controls/subtitles-button.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-video.js/node_modules/video.js/es5/control-bar/text-track-controls/subtitles-button.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-video.js/node_modules/video.js/es5/control-bar/text-track-controls/</a> &#187; subtitles-button.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function SubtitlesButton(player, options, ready) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, SubtitlesButton);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.el_.setAttribute('aria-label', 'Subtitles Menu');</span>
...
&nbsp;
&nbsp;
  SubtitlesButton.prototype.buildCSSClass = <span class="fstat-no" title="function not covered" >function buildCSSClass() {</span>
<span class="cstat-no" title="statement not covered" >    return 'vjs-subtitles-button ' + _TextTrackButton.prototype.buildCSSClass.call(this);</span>
  };
&nbsp;
