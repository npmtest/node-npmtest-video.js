...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-video.js/node_modules/video.js/es5/control-bar/track-button.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-video.js/node_modules/video.js/es5/control-bar/track-button.js</span></h1>
    <h2>
        
        Statements: <span class="metric">48.08% <small>(25 / 52)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-video.js/node_modules/video.js/es5/control-bar/</a> &#187; track-button.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function TrackButton(player, options) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, TrackButton);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (_this.items.length &lt;= 1) {</span>
...
<span class="cstat-no" title="statement not covered" >      return _possibleConstructorReturn(_this);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var updateHandler = Fn.bind(_this, _this.update);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    tracks.addEventListener('removetrack', updateHandler);</span>
<span class="cstat-no" title="statement not covered" >    tracks.addEventListener('addtrack', updateHandler);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.player_.on('dispose', <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      tracks.removeEventListener('removetrack', updateHandler);</span>
<span class="cstat-no" title="statement not covered" >      tracks.removeEventListener('addtrack', updateHandler);</span>
    });
