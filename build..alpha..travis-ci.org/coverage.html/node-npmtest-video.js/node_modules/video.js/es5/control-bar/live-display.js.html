...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-video.js/node_modules/video.js/es5/control-bar/live-display.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-video.js/node_modules/video.js/es5/control-bar/live-display.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-video.js/node_modules/video.js/es5/control-bar/</a> &#187; live-display.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function LiveDisplay(player, options) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, LiveDisplay);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.updateShowing();</span>
<span class="cstat-no" title="statement not covered" >    _this.on(_this.player(), 'durationchange', _this.updateShowing);</span>
...
&nbsp;
&nbsp;
  LiveDisplay.prototype.createEl = <span class="fstat-no" title="function not covered" >function createEl() {</span>
...
&nbsp;
&nbsp;
  LiveDisplay.prototype.updateShowing = <span class="fstat-no" title="function not covered" >function updateShowing(event) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.player().duration() === Infinity) {</span>
