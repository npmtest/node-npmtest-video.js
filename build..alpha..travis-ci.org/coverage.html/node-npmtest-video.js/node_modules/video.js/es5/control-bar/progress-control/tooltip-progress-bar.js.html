...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-video.js/node_modules/video.js/es5/control-bar/progress-control/tooltip-progress-bar.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-video.js/node_modules/video.js/es5/control-bar/progress-control/tooltip-progress-bar.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-video.js/node_modules/video.js/es5/control-bar/progress-control/</a> &#187; tooltip-progress-bar.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function TooltipProgressBar(player, options) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, TooltipProgressBar);</span>
&nbsp;
...
&nbsp;
&nbsp;
  TooltipProgressBar.prototype.createEl = <span class="fstat-no" title="function not covered" >function createEl() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.tooltip = el.querySelector('.vjs-time-tooltip');</span>
&nbsp;
...
&nbsp;
&nbsp;
  TooltipProgressBar.prototype.updateDataAttr = <span class="fstat-no" title="function not covered" >function updateDataAttr(event) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.el_.setAttribute('data-current-time', formattedTime);</span>
<span class="cstat-no" title="statement not covered" >    this.tooltip.innerHTML = formattedTime;</span>
  };
&nbsp;
