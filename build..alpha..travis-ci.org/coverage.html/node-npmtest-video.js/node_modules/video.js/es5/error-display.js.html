...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-video.js/node_modules/video.js/es5/error-display.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-video.js/node_modules/video.js/es5/error-display.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">74.07% <small>(20 / 27)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-video.js/node_modules/video.js/es5/</a> &#187; error-display.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function ErrorDisplay(player, options) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, ErrorDisplay);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, _ModalDialog.call(this, player, options));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.on(player, 'error', _this.open);</span>
...
&nbsp;
&nbsp;
  ErrorDisplay.prototype.buildCSSClass = <span class="fstat-no" title="function not covered" >function buildCSSClass() {</span>
<span class="cstat-no" title="statement not covered" >    return 'vjs-error-display ' + _ModalDialog.prototype.buildCSSClass.call(this);</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  ErrorDisplay.prototype.content = <span class="fstat-no" title="function not covered" >function content() {</span>
<span class="cstat-no" title="statement not covered" >    var error = this.player().error();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return error ? this.localize(error.message) : '';</span>
  };
&nbsp;
  return ErrorDisplay;
